...
final class AppDatabaseTests: XCTestCase {
    ...
    private func makeDatabase() throws -> AppDatabase {
        ...
        db.saveProfile(ProfileRecord(id: testProfileID, name: "Test", userAgentMode: 0, customUserAgent: nil, archiveThreshold: 43200, sleepThreshold: 3600, searchEngine: 0, searchSuggestionsEnabled: true, isPerTabIsolation: false))
        return db
    }
